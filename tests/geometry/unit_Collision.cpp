...
const Poligon2d cPoligon{Point2d{0.2, 0.2}, Point2d{0.2, 0.4}, Point2d{0.4, 0.2}, Point2d{0.4, 0.4}};
TEST_CASE("Poligon collision", "[geometry][collision][object]") {
  auto outside = GENERATE(Point2d{-0.1, 0}, Point2d{0.3, 0.5}, Point2d{0, 1.1});
  REQUIRE_FALSE(collision::collides(outside, cPoligon));

  auto inside = GENERATE(Point2d{0.3, 0.3}, Point2d{0.25, 0.35});
  REQUIRE(collision::collides(inside, cPoligon));
}
